import { JobNumberingFormHelperFunction } from "@/helpers/FormHelper";
import { useForm } from "react-hook-form";

const JobNumberingForm = () => {
  const list = JobNumberingFormHelperFunction();
...
export default JobNumberingForm;
